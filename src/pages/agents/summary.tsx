...
interface InfoInterface {
    ...
    transfersettlementFirstName?: string,
    transfersettlementSecondName?: string,
}
export default function MdaDashboard() {
    ...
    const [transferInfo, setTransferInfo] = useState<InfoInterface>({
        ...
        transferMessage: "",
        transferKeyWord: "",
        transfersettlementFirstName: "",
        transfersettlementSecondName: "",
    });
    ...
    useEffect(() => {
        setTransferInfo({
            ...
            transferKeyWord: localStorage.getItem("transferKeyWord") ?? "",
            transfersettlementFirstName: localStorage.getItem("transfersettlementFirstName") ?? "",
            transfersettlementSecondName: localStorage.getItem("transfersettlementSecondName") ?? ""
        })
    }, [])
                        ...
                        <div>
                            <div className="w-[90%] md:w-[50%] mx-auto block mb-20">
                                ...
                                <div className="text-center mt-10">
                                    ...
                                    <div className="mt-3 md:w-[80%] mx-auto">
                                        {
                                            transferInfo.transferStatus === "queue" ?
                                                <p className="leading-loose">Your transfer of {transferInfo?.transferAmount ? formatAmount(+transferInfo.transferAmount) : ""} {transferInfo.transferKeyWord} {capitalizeText(transferInfo.transfersettlementFirstName)} {capitalizeText(transferInfo.transfersettlementSecondName)}&apos;s wallet
                                                    has been queued successfully.</p>
                                                :
                                                transferInfo.transferStatus === "pending" ?
                                                    <p className="leading-loose">Your {transferInfo?.transferAmount ? formatAmount(+transferInfo.transferAmount) : ""} {transferInfo.transferKeyWord} {capitalizeText(transferInfo.transfersettlementFirstName)} {capitalizeText(transferInfo.transfersettlementSecondName)}&apos;s wallet
                                                        is pending and will be processed shortly.</p>
                                                    :
                                                    <p className="leading-loose">Your {transferInfo?.transferAmount ? formatAmount(+transferInfo.transferAmount) : ""} {transferInfo.transferKeyWord} {capitalizeText(transferInfo.transfersettlementFirstName)} {capitalizeText(transferInfo.transfersettlementSecondName)}&apos;s wallet
                                    ...
                                    <div className="mt-10">
                                        <Link href="/agents" className="bg-primary text-white w-full py-6 block px-20 rounded-lg">View All Sub-Agents</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
