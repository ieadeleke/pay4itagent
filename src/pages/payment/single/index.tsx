...
import { useVerifyHarmonizeReference } from "@/utils/apiHooks/charge/useVerifySingleReference";
import HarmonizePaymentContent from "@/components/payment/HarmonizeSinglePaymentContent";
...
export default function Settings() {
    ...
    const verifyUserPaymentRef = (key: string) => {
